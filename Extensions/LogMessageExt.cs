...
internal static class LogMessageExt
{
    /// <summary>
    ...
    /// <returns></returns>
    public static Task LogAsync(this LogMessage log)
    {
    ...
    /// <summary>
    /// Log message to a Discord channel as an embed.
    /// </summary>
    /// <param name="log"></param>
    /// <param name="logChannel"></param>
    /// <returns></returns>
    public static async Task LogAsync(this LogMessage log, SocketTextChannel logChannel)
    {
